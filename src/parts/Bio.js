      ...
      >
        ...
        <div style={{ maxWidth: "600px" }}>
          ...
          <p className="mb-4">
            ...
            library reactjs and framwork tailwindcss for development but i can
            use other option like bootstrap and ant design.
          </p>
          <div className="flex flex-wrap">
            ...
            <div className="flex items-center mr-8">
              <img className="mr-2" src={cake} alt="icons cake" />{" "}
              <p>21 Years</p>
            </div>
          </div>
        </div>
